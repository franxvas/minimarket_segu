...
En minimarket_segu-labels_es.properties:
minimarket_segu=Tu aplicación
minimarket_segu[description]=Tu aplicación hace esto y lo otro

En minimarket_segu-messages_en.properties:
