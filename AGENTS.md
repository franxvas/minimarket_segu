...
- Crea la clase de la acción en el paquete `com.minimarket.minimarket_segu.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.minimarket.minimarket_segu.acciones.MostrarImporte"/>
</controlador>
```
...
- ✅ Coloca las clases de acción en `com.minimarket.minimarket_segu.acciones`
...
- Crea un paquete `cuadrosmando` (ej. `com.minimarket.minimarket_segu.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
